     ...
     >
      <div className='w-full flex justify-between item-center max-w-7xl mx-auto'>
         ...
         >
          ...
          <p className='text-white text-[18] font-bold cursur-pointer flex'>Medinat &nbsp; <span className='sm:block hidden'>| Akinsowon</span></p>
         </Link>
         ...
         <div className='sm:hidden flex flex-1 justify-end items-center'>
            ...
            {navLinks.map((link)=>(
              <li key={link.id} className={`${active === link.title ? "text-white" : "text-secondary" } font-poppins font-medium cursur-pointer text-[16px]`} onClick={()=>{
                setToggle(!toggle);
